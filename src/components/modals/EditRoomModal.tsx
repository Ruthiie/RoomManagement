    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md rounded-2xl p-5 bg-white font-[Lexend]">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-2 text-sm">
          ...
          {/* Room Name — moved down and next to Room Type */}
                  ...
                  <div className="flex justify-end items-center">
                    {hasName ? (
                      <button
                        ...
                        className="inline-flex items-center justify-center h-7 w-7 rounded-full bg-[#ff4d4f] hover:bg-[#e04141] text-white"
                      >
                      ...
                      <button
                        aria-label={`add-${idx}`}
                        className="inline-flex items-center justify-center h-7 w-7 rounded-full bg-[#01889f] hover:bg-[#017A8F] text-white"
                      >
